...
const Sidebar = () => {
  ...
  return (
    <div className='text-gray-500 p-5 text-sm border-r lg:text-m
    ...
    lg:max-w-[15rem] hidden md:inline-flex pb-36'>
        <div className='space-y-4'>
            ...
            <button className='flex items-center space-x-2 hover:text-white'>
                <LibraryIcon className='flex items-center space-x-2' className='h-5 w-5' />
                <p>Your Library</p>
            </button>
          ...
          <button className='flex items-center space-x-2 hover:text-white'>
                <PlusCircleIcon className='flex items-center space-x-2' className='h-5 w-5' />
                <p>Create Playlist</p>
            </button>
